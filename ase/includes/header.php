<head>
    <title>Dashboard: * paginanaam *</title>
    ...
    <link rel="stylesheet" href="../../lib/css/ase/bootstrap/bootstrap.min.css">
    <link rel="stylesheet" href="../../lib/css/ase/icon-awesome/css/font-awesome.min.css">
    <link rel="stylesheet" href="../../lib/css/ase/icon-line/css/simple-line-icons.css">
    <link rel="stylesheet" href="../../lib/css/ase/icon-etlinefont/style.css">
    <link rel="stylesheet" href="../../lib/css/ase/icon-line-pro/style.css">
    <link rel="stylesheet" href="../../lib/css/ase/icon-hs/style.css">
    <link rel="stylesheet" href="../../lib/css/ase/hs-admin-icons/hs-admin-icons.css">

    <link rel="stylesheet" href="../../lib/css/ase/animate.css">
    <link rel="stylesheet" href="../../lib/css/ase/malihu-scrollbar/jquery.mCustomScrollbar.min.css">

    <link rel="stylesheet" href="../../lib/css/ase/flatpickr/dist/css/flatpickr.min.css">
    <link rel="stylesheet" href="../../lib/css/ase/bootstrap-select/css/bootstrap-select.min.css">

    <link rel="stylesheet" href="../../lib/css/ase/chartist-js/chartist.min.css">
    <link rel="stylesheet" href="../../lib/css/ase/chartist-js-tooltip/chartist-plugin-tooltip.css">
    <link rel="stylesheet" href="../../lib/css/ase/fancybox/jquery.fancybox.min.css">

    <link rel="stylesheet" href="../../lib/css/ase/hamburgers/hamburgers.min.css">
    <link rel="stylesheet" href="../../lib/css/ase/unify-admin.css">
    <link rel="stylesheet" href="../../lib/css/ase/custom.css">
</head>
    ...
    <div class="u-header__section u-header__section--admin-dark g-min-height-65">
                    ...
                    <div id="messagesMenu" class="g-absolute-centered--x g-width-340 g-max-width-400 g-mt-17 rounded"
                        ...
                        <div class="media u-header-dropdown-bordered-v1 g-pa-20">
                            <h4 class="d-flex align-self-center text-uppercase g-font-size-default g-letter-spacing-0_5 g-mr-20 g-mb-0">
                                3 nieuwe berichten</h4>
                            <div class="media-body align-self-center text-right">
                                <a class="g-color-secondary" href="#!">Alles bekijken</a>
                            </div>
                        </div>
                        ...
                        <ul class="p-0 mb-0">
                            <li class="media g-pos-rel u-header-dropdown-item-v1 g-pa-20">
                                <div class="d-flex g-mr-15">
                                    <img class="g-width-40 g-height-40 rounded-circle"
                                         src="../../lib/images/ase/temporary/100x100/img5.jpg" alt="Image Description">
                                </div>

                                <div class="media-body">
                                    <h5 class="g-font-size-16 g-font-weight-400 g-mb-5"><a href="#!">Jurgen Klomp</a>
                                    </h5>
                                    <p class="g-mb-10">Bericht 1</p>
                                ...
                                <a class="u-link-v2" href="#!">Bekijken</a>
                            </li>

                            <li class="media g-pos-rel u-header-dropdown-item-v1 g-pa-20">
                                <div class="d-flex g-mr-15">
                                    <img class="g-width-40 g-height-40 rounded-circle"
                                         src="../../lib/images/ase/temporary/100x100/img6.jpg" alt="Image Description">
                                </div>

                                <div class="media-body">
                                    <h5 class="g-font-size-16 g-font-weight-400 g-mb-5"><a href="#!">Mike Schepers</a>
                                    </h5>
                                    <p class="g-mb-10">Bericht 2</p>

                                    <em class="d-flex align-self-center align-items-center g-font-style-normal g-color-lightblue-v2">
                                        <i class="hs-admin-time icon-clock g-mr-5"></i>
                                        <small>10 min geleden</small>
                                    </em>
                                </div>
                                <a class="u-link-v2" href="#!">Bekijken</a>
                            </li>
                            ...
                            <li class="media g-pos-rel u-header-dropdown-item-v1 g-pa-20">
                                <div class="d-flex g-mr-15">
                                    <img class="g-width-40 g-height-40 rounded-circle"
                                         src="../../lib/images/ase/temporary/100x100/img7.jpg" alt="Image Description">
                                </div>

                                <div class="media-body">
                                    <h5 class="g-font-size-16 g-font-weight-400 g-mb-5"><a href="#!">Nyma
                                            Dolatkhahnejad</a>
                                    </h5>
                                    <p class="g-mb-10">Bericht 3</p>

                                    <em class="d-flex align-self-center align-items-center g-font-style-normal g-color-lightblue-v2">
                                        <i class="hs-admin-time icon-clock g-mr-5"></i>
                                        <small>15 min geleden</small>
                                    </em>
                                </div>
                                <a class="u-link-v2" href="#!">Bekijken</a>
                            </li>
        ...
        <span class="u-badge-v2--xs u-badge--top-right g-hidden-sm-up g-bg-lightblue-v5 g-mr-5"></span>
                <img class="g-width-30 g-width-40--md g-height-30 g-height-40--md rounded-circle g-mr-10--sm"
                     src="../../lib/images/ase/temporary/125x125/img1.jpg" alt="Image descriptie">
                </span>
                            <span class="g-pos-rel g-top-2">
        <span class="g-hidden-sm-down">Nyma Dolatkhahnejad</span>
          ...
          <span class="u-badge-v1 g-top-minus-3 g-right-minus-3 g-width-18 g-height-18 g-bg-lightblue-v5 g-font-size-10 g-color-white rounded-circle p-0">3</span>
                    <i class="hs-admin-comment-alt"></i>
                    </span>
                                    <span class="media-body align-self-center">Berichten</span>
                                </a>
                            </li>
                            <li class="g-hidden-sm-up g-mb-10">
                                <a class="media g-py-5 g-px-20" href="#!">
          ...
          <i class="hs-admin-bell"></i>
                                    ...
                                    <span class="media-body align-self-center">Notificaties</span>
                                </a>
                            </li>
                            <li class="g-mb-10">
                                <a class="media g-color-lightred-v2--hover g-py-5 g-px-20" href="my_settings.php">
                    <span class="d-flex align-self-center g-mr-12">
          <i class="hs-admin-id-badge"></i>
        </span>
                                    <span class="media-body align-self-center">Mijn instellingen</span>
                                </a>
                            </li>
                            <li class="g-mb-10">
                                <a class="media g-color-lightred-v2--hover g-py-5 g-px-20" href="site_settings.php">
                    <span class="d-flex align-self-center g-mr-12">
          <i class="hs-admin-settings"></i>
        </span>
                                    <span class="media-body align-self-center">Site instellingen</span>
                                </a>
                            </li>
                            <li class="mb-0">
          ...
          <i class="hs-admin-power-off"></i>
                                    ...
                                    <span class="media-body align-self-center">Uitloggen</span>
                                </a>
                            </li>
                        </ul>
                    </div>
